...
//***
        ...
        $rate_alert= new WOOBE_RATE_ALERT(false);
        $rate_alert->init();     
...
//***
        ...
        switch ($this->settings->active_fields[$field_key]['edit_view']) {
            ...
            case 'calendar':
                ...
                $res = WOOBE_HELPER::draw_calendar($product_id, $post_title . ' (' . $this->settings->active_fields[$field_key]['title'] . ')', $field_key, $val,"",false,true);
                break;
